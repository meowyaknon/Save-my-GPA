...
public class GoodSeatEvent extends Event {
    ...
    protected void applyEffects(Player player, TimeSystem timeSystem) {
        ...
        player.changeStat(StatType.INTELLIGENCE, 5); // lucky bonus int (bypasses debuff modifiers intentionally)
        System.out.println("[Event] ได้นั่งมุมโปรด! แอร์เย็นฉ่ำ ปลั๊กไฟพร้อม ที่นั่งว่างพอดี สมาธิมาเต็มร้อย");
    }

    @Override
    protected String getName() { return "ได้นั่งมุมโปรด"; }

    @Override
    protected String getDescription() {
        return "แอร์เย็นฉ่ำ ปลั๊กไฟพร้อม ที่นั่งว่างพอดี สมาธิมาเต็มร้อย";
    }
