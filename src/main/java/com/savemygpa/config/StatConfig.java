...
public final class StatConfig {
    ...
    public static final int CLASSROOM_MOOD_LOSS = 15;
    public static final int CLASSROOM_ENERGY_LOSS = 3;

    public static final int CLASSROOM_MOOD_REQUIREMENT = 15;
    public static final int CLASSROOM_ENERGY_REQUIREMENT = 3;
    ...
    public static final int RELAX_ENERGY_GAIN = 15;
